...
class Albums extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nom, descripcio, portada, aprovat', 'required'),
			array('nom, descripcio, portada, aprovat', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nom, descripcio, portada, aprovat', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'albums' => array(self::BELONGS_TO, 'Albums', 'id'),
		);
		
		//'cromos' => array(self::BELONGS_TO, 'Cromos', 'cromo_id'),
	}
	/**
