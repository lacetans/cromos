...
class Cromos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descripcio, aprovat, numeracio', 'required'),
			array('aprovat, numeracio', 'numerical', 'integerOnly'=>true),
			array('descripcio', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, descripcio, aprovat, numeracio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('numeracio',$this->numeracio);
