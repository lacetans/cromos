...
/**
 * This is the model class for table "preguntes_omplir_blancs".
 *
 * The followings are the available columns in table 'preguntes_omplir_blancs':
 * @property integer $id
 * @property string $pregunta
 * @property string $resposta
 * @property integer $pregunta_id
 */
class PreguntesOmplirBlancs extends CActiveRecord
{
	/**
	...
	{
		return 'preguntes_omplir_blancs';
	}
	 ...
	 * @return PreguntesOmplirBlancs the static model class
	 */
