...
class Usuaris extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email, password', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			//'coleccio'=>array(self::BELONGS_TO,'Coleccio','usuaris_id'),  // Molts a 1
			'albums'=>array(self::MANY_MANY,'Albums','Coleccio(album_id,usuari_id)'),
		);
	}
