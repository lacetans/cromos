...
$this->menu=array(
	...
	array('label'=>'Update PreguntesHospot', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete PreguntesHospot', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage PreguntesHospot', 'url'=>array('admin')),
);
?>

<h1>View PreguntesHospot #<?php echo $model->id; ?></h1>
